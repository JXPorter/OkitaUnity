...
//			// this line checks to see if the go has no ZombieState attached or an instance of this object itself
//			if (z == null || z == this) 
//			{
...
//		Vector3 directionToMove = MoveAway - MoveTo; // this gives us a push away from the closest object and moves the zombie toward the furthest object
//		transform.forward = directionToMove; // turns the zombie in this direction
//		gameObject.GetComponent<Rigidbody>().velocity = directionToMove * Random.Range (10, 20) * 0.1f; // gives zombie push in that direction
