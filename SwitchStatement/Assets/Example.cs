...
// NOTE: A SWITCH STATEMENT can only use integral, bool, char, string, enum, or nullable types of data. It does not work with floats. 
// SWITCH statements should only be used when one and only one thing needs to happne based on a single parameter.
{
	public int i = 3;
